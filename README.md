...
| **管理者通知信箱（7 人）** | `jacky.lin`, `syay.shih`, `yijie.lee`, `addy.li`, `peter`, `kai`, `milu.tsai` @gptt.com.tw |
...
- 自動寄 Gmail 通知給 7 位管理者，信件標題格式：`[緊急] 設備故障通報_(sn:xxx)` 或 `設備故障通報_(sn:xxx)`
